...
if(isset($_GET['function']) && !empty($_GET['function'])){
    function grabar(){
        ...
        $dbh = mysql_connect("mysql1051.servage.net", "cotizatv1", "cotizaTV2011") or die('problema: ' . mysql_error());
        ...
        //Crear cadena para grabar cada rengl�n
        //1.Motocultores 2.Arados 3.Rastras 4.Implemento_1 5.Implemento_2 6.Implemento_3 7.Implemento_4 8.Implemento_5 9.Capacitaci�n 10.Servicio_1 11.Servicio_2
...
//Array para poner en espa�ol el d�a y el mes
...
//Leer cantidades y descripciones de los art�culos
//Equipos
...
<?
//Validar que seleccionaron algo y separar el precio de la descripci�n para cada caso
if($equipos != "Equipos" && ($cantequipos != null || $cantequipos !=""))
{
  ...
  //Subir las variables a nivel sesi�n para el grabado
...
if($capac != "Capacitaci�n" && ($cantcapac != null || $cantcapac !=""))
{
