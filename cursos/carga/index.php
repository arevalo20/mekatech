<html>
<head>
  <title>Alta de cursos de capacitación</title>
...
?>
  <titulo>Alta de cursos de capacitación - Mekatech</titulo>
  <br>
  <form method="post" action="" enctype="multipart/form-data">
   <body>
   Fecha curso: <input size="10" id="fc_1287699270" type="text" READONLY name="fecha" title="DD/MM/YYYY" value="MM/DD/YYYY"> <a href="javascript:displayCalendarFor('fc_1287699270');"><img src="http://tw01.sytes.net:8080/com/images/cal.jpg" border="0"></a>
   </br>
   Nombre capacitador: <input type="text" name="nombre">
   </br>
   Lugar capacitación: <input type="text" name="lugar">
   </br>
   Archivo asistentes: <input type="file" name="form_data" size="40">
   </br>
