...
<div id='crmWebToEntityForm' style='width:800px;margin:auto;'>
   ...
   <form action='https://crm.zoho.com/crm/WebToLeadForm' name=WebToLeads2117231000000208065 method='POST' onSubmit='javascript:document.charset="UTF-8"; return checkMandatory()' accept-charset='UTF-8'>
	...
	<input type='text' style='display:none;' name='returnURL' value='http&#x3a;&#x2f;&#x2f;mekatech.tv&#x2f;newsletterzoho2.php' /> 
	 <!-- Do not remove this code. -->
	...
	<tr><td colspan='2' style='text-align:left;color:black;font-family:Verdana;font-size:17px;'><strong>Datos Mekatech</strong></td></tr>

	<tr><td  style='nowrap:nowrap;text-align:left;font-size:15px;font-family:Verdana;width:200px;'>Nombre<span style='color:red;'>*</span></td><td style='width:250px;' ><input type='text' style='width:250px;'  maxlength='40' name='First Name' /></td></tr>

	<tr><td  style='nowrap:nowrap;text-align:left;font-size:15px;font-family:Verdana;width:200px;'>Apellidos<span style='color:red;'>*</span></td><td style='width:250px;' ><input type='text' style='width:250px;'  maxlength='80' name='Last Name' /></td></tr>

	<tr><td  style='nowrap:nowrap;text-align:left;font-size:15px;font-family:Verdana;width:200px;'>Correo electr&oacute;nico<span style='color:red;'>*</span></td><td style='width:250px;' ><input type='text' style='width:250px;'  maxlength='100' name='Email' /></td></tr>

	<tr><td  style='nowrap:nowrap;text-align:left;font-size:15px;font-family:Verdana;width:200px;'>Tel&eacute;fono<span style='color:red;'>*</span></td><td style='width:250px;' ><input type='text' style='width:250px;'  maxlength='30' name='Phone' /></td></tr>

	<tr><td  style='nowrap:nowrap;text-align:left;font-size:15px;font-family:Verdana;width:200px;'>Empresa</td><td style='width:250px;' ><input type='text' style='width:250px;'  maxlength='100' name='Company' /></td></tr>

	<tr><td colspan='2' style='text-align:center; padding-top:15px;'>
		<input style='font-size:15px;color:#131307' type='submit' value='Enviar' />
		<input type='reset' style='font-size:15px;color:#131307' value='Restablecer' />
	    </td>
	</tr>
   </table>
	<script>
