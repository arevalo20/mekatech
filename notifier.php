...
function notifyEmail($emailAddress,$fecha) {
	...
	$mail->AddAddress('efren.talavera@tech-innovations.tv','Soporte Tecnico');
	//$mail->AddCC('oliva.hernandez@w2a.com.mx','Oliva Hernandez');
	//$mail->AddBCC('soporte@w2a.com.mx','Soporte Tecnico');
	
	$mail->Subject = "Notificacion registro de correo electronico en siti Mekatech";
